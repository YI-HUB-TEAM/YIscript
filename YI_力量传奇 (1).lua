...
-- ================== 只保留第一个顶级 Section ==================
local MainSection = Window:Section({ Title = "伊蕾娜真的超可爱", Opened = true })

-- ================== 创建所有标签页（变量名改为 MainTabs） ==================
local MainTabs = {
    Info = MainSection:Tab({ Title = "信息", Icon = "info" }),
    Main = MainSection:Tab({ Title = "主要", Icon = "layout-grid" }),
    Rocks = MainSection:Tab({ Title = "打石头", Icon = "pickaxe" }),
    Karma = MainSection:Tab({ Title = "刷业报", Icon = "sword" }),
    Equipment = MainSection:Tab({ Title = "其他器材", Icon = "dumbbell" }),
    Rebirth = MainSection:Tab({ Title = "重生", Icon = "repeat" }),
    Modify = MainSection:Tab({ Title = "修改", Icon = "edit" }),
    Teleport = MainSection:Tab({ Title = "传送", Icon = "map-pin" }),
    Collect = MainSection:Tab({ Title = "收集", Icon = "package" }),
    Pets = MainSection:Tab({ Title = "宠物蛋", Icon = "egg" }),
    Graphics = MainSection:Tab({ Title = "画质+通用", Icon = "monitor" })
}

-- ================== 清空并重新填充 Info 标签页内容 ==================
-- (WindUI 创建时标签页为空，直接添加即可)
MainTabs.Info:Paragraph({
    Title = "欢迎使用该脚本",
    Desc = "当前加载为力量传奇",
    Image = "scroll-text",
    ImageSize = 30,
    Thumbnail = "https://raw.githubusercontent.com/951357nvjn/dyzs/refs/heads/main/mmexport1774101687773.jpeg",
    ThumbnailSize = 200
})
MainTabs.Info:Paragraph({
    Title = "脚本权限",
...
getgenv().RK10 = false
getgenv().RK100 = false
getgenv().RK5000 = false
getgenv().RK150000 = false
getgenv().RK400000 = false
getgenv().RK750000 = false
getgenv().RK1M = false
getgenv().RK5M = false
getgenv().JungleRock10M = false

getgenv().AutoKarmaV3 = false
...
getgenv().PPJ10 = false
getgenv().PPJ2000 = false
getgenv().SHPPJ2000 = false
getgenv().YHPPJ3500 = false
getgenv().CQPPJ3000 = false
getgenv().JungleTreadmill = false

getgenv().SquatBeach = false
getgenv().SquatFrostGym = false
getgenv().SquatLegendGym = false
getgenv().SquatMuscleGym = false
getgenv().SquatJungleGym = false

getgenv().PullupBeach = false
getgenv().PullupMythGym = false

getgenv().ThrowBeach = false
getgenv().ThrowMythGym = false
getgenv().ThrowLegendGym = false
getgenv().ThrowMuscleGym = false
getgenv().ThrowJungleGym = false

getgenv().AutoRebirth = false
Interstellar = Interstellar or {}
Interstellar.birth = 0
Interstellar.autobirth = false

getgenv().SafeSpot2 = false
getgenv().SafeSpot3 = false
...
-- ================== 主要标签页内容 ==================
local otherSection = MainTabs.Main:Section({ Title = "比赛类", Opened = true })
MainTabs.Main:Toggle({
    Title = "自动比赛开关",
    Default = false,
...
local otherSection = MainTabs.Main:Section({ Title = "防打自动训练", Opened = true })
MainTabs.Main:Paragraph({
    Title = "关于防打自动锻炼",
    Desc = "死亡后不会继续\n因为继续会失去道具\n所以我就没弄\n我建议的是不防打和安全点循环传送即可",
    ThumbnailSize = 190,
})
...
local otherSection2 = MainTabs.Main:Section({ Title = "不防打可移动自动训练", Opened = true })
MainTabs.Main:Toggle({
    Title = "自动举哑铃",
    Default = false,
    Callback = function(state)
        getgenv().AutoWeight2 = state
        spawn(function()
            while getgenv().AutoWeight2 do
                pcall(function()
                    local char = game.Players.LocalPlayer.Character
            ...
            if not getgenv().AutoWeight2 then
...
-- ================== 打石头标签页内容 ==================
local rockSection = MainTabs.Rocks:Section({ Title = "石头对照表", Opened = true })
MainTabs.Rocks:Paragraph({
    Title = "自行对照",
...
local rockSection = MainTabs.Rocks:Section({ Title = "远程打石头v1", Opened = true })
local rockshow1 = {"Tiny Rock", "Inferno Rock", "Punching Rock", "Rock Of Legends", "Muscle King Mountain", "Ancient Jungle Rock"}
Interstellar = Interstellar or {}
Interstellar.Rocks = "Tiny Rock"
MainTabs.Rocks:Dropdown({
    Title = "选择石头", 
    Values = rockshow1, 
    Value = "空", 
...
local rockSection3 = MainTabs.Rocks:Section({ Title = "打石头(传送过去)", Opened = true })
MainTabs.Rocks:Toggle({
    Title = "石头0",
    Default = false,
    Callback = function(state)
...
-- ================== 刷业报标签页内容 ==================
local karmaSection = MainTabs.Karma:Section({ Title = "自动刷业报", Opened = true })
MainTabs.Karma:Toggle({
    Title = "自动刷业报v1",
...
local karmaSection2 = MainTabs.Karma:Section({ Title = "自定义", Opened = true })
...
local killplayerDropdown = MainTabs.Karma:Dropdown({
    Title = "要远程的玩家",
    Values = PlayerList,
    Value = {},
    Multi = true,
...
-- ================== 其他器材标签页内容 ==================
local equipmentSection = MainTabs.Equipment:Section({ Title = "跑步机", Opened = true })
MainTabs.Equipment:Toggle({
    Title = "沙滩跑步机10",
    Default = false,
    Callback = function(state)
        getgenv().PPJ10 = state
...
local squatSection = MainTabs.Equipment:Section({ Title = "深蹲器材", Opened = true })
MainTabs.Equipment:Toggle({
    Title = "沙滩深蹲架",
    Default = false,
    Callback = function(state)
...
local pullupSection = MainTabs.Equipment:Section({ Title = "引体向上器材", Opened = true })
MainTabs.Equipment:Toggle({
    Title = "沙滩引体向上",
    Default = false,
    Callback = function(state)
...
local throwSection = MainTabs.Equipment:Section({ Title = "丢石头", Opened = true })
MainTabs.Equipment:Toggle({
    Title = "沙滩投掷石",
    Default = false,
    Callback = function(state)
...
-- ================== 重生标签页内容 ==================
local rebirthSection = MainTabs.Rebirth:Section({ Title = "自动重生", Opened = true })
MainTabs.Rebirth:Toggle({
    Title = "自动重生",
    Default = false,
    Callback = function(state)
...
local customSection = MainTabs.Rebirth:Section({ Title = "自定义", Opened = true })
MainTabs.Rebirth:Input({
    Title = "自定义重生次数",
    Desc = "只能输入大于现在的重生次数",
    Callback = function(value)
...
MainTabs.Rebirth:Divider()
MainTabs.Rebirth:Paragraph({
...
-- ================== 修改标签页内容 ==================
local modifySection = MainTabs.Modify:Section({ Title = "美化数据", Opened = true })
MainTabs.Modify:Input({
    Title = "力量",
    Desc = "输入力量数值",
    Callback = function(value)
...
MainTabs.Teleport:Toggle({
    ...
    Default = false,
    Callback = function(state)
        getgenv().SafeSpot3 = state
        spawn(function()
            while getgenv().SafeSpot3 do 
                wait()
                pcall(function()
                    local char = game.Players.LocalPlayer.Character 
                    if not char then 
...
-- ================== 收集标签页内容 ==================
local collectSection = MainTabs.Collect:Section({ Title = "功能", Opened = true })
MainTabs.Collect:Button({
    Title = "使用一次奶昔",
    Callback = function()
        local char = game.Players.LocalPlayer.Character 
...
local crystalNames = {
    ...
    ["肌肉王宠物蛋"] = "Muscle Elite Crystal",
    ["银河先知宠物蛋"] = "Galaxy Oracle Crystal",
...
local buySection = MainTabs.Pets:Section({ Title = "购买", Opened = true })
MainTabs.Pets:Paragraph({
    Title = "关于直接购买宠物",
    Desc = "你得保证你有充足的宝石\n因为购买一个宠物就值0.4亿左右\n否则购买失败",
    ThumbnailSize = 200,
})
...
local evolveSection = MainTabs.Pets:Section({ Title = "进化", Opened = true })
MainTabs.Pets:Toggle({
    Title = "自动进化赛博对决龙",
    Default = false,
    Callback = function(s)
...
local crystalSection = MainTabs.Pets:Section({ Title = "宠物蛋", Opened = true })
MainTabs.Pets:Paragraph({
    Title = "自行对照",
...
local OpenCrystal = "Blue Crystal"
MainTabs.Pets:Dropdown({
    Title = "选择宠物蛋",
    Values = crystalshow,
    Value = "空",
...
-- ================== 画质+通用标签页内容 ==================
local otherSection = MainTabs.Graphics:Section({ Title = "常用功能", Opened = true })
otherSection:Toggle({
    Title = "去雾", 
    Default = false, 
    Callback = function(state)
